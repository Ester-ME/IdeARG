...
```{r}
# CC4
CC4_mobileog <- read_delim("../results_coassembly_megahit_MAGs_90_10/CC4/mobileOG/CC4.mobileog.m8", delim = "\t", escape_double = FALSE, trim_ws = TRUE, col_names=F)
...
# CD4
CD4_mobileog <- read_delim("../results_coassembly_megahit_MAGs_90_10/CD4/mobileOG/CD4.mobileog.m8", delim = "\t", escape_double = FALSE, trim_ws = TRUE, col_names=F)
...
# MC4
MC4_mobileog <- read_delim("../results_coassembly_megahit_MAGs_90_10/MC4/mobileOG/MC4.mobileog.m8", delim = "\t", escape_double = FALSE, trim_ws = TRUE, col_names=F)
...
# MD4
MD4_mobileog <- read_delim("../results_coassembly_megahit_MAGs_90_10/MD4/mobileOG/MD4.mobileog.m8", delim = "\t", escape_double = FALSE, trim_ws = TRUE, col_names=F)
...
# FC4
FC4_mobileog <- read_delim("../results_coassembly_megahit_MAGs_90_10/FC4/mobileOG/FC4.mobileog.m8", delim = "\t", escape_double = FALSE, trim_ws = TRUE, col_names=F)
...
# FD4
FD4_mobileog <- read_delim("../results_coassembly_megahit_MAGs_90_10/FD4/mobileOG/FD4.mobileog.m8", delim = "\t", escape_double = FALSE, trim_ws = TRUE, col_names=F)
...
mobileOG_contigs <- mobileog_basic %>%
  ...
  separate(qtitle, c("contigC", "contigN", "orfC", "orfN"), sep = "_", fill = 'right', extra = 'drop') %>%
...
# mobileOG_contigs %>%
#   write.table("./COASSEMBLY_mobileOG/Master_mobileOG_filtered_onCoASSEMBLY.tsv", quote = F, row.names = F, sep = "\t")
...
# How many MGEs are in each contig?

contigs_summary_table <- mobileOG_contigs %>% 
  dplyr::select(sample,contig) %>%
